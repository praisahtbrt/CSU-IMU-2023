...
head(iris)
summary(iris)
# Begin by separating the data into 2 parts: 
#  - a training sample
#  - a test sampole.
...
# The best classification is obtained for k=7... 
# But: 
# 1. this result will vary as a function of the random initialization
# 2. one should preferably present an average error plus deviation, and not the best one
# 3. this result then needs to be confronted with the knowledge of a domain expert 
#    i.e. a botanist.
